...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript"> 
			...
			F = new Array();
			F[0] = new Array();
			F[0][0]='La magnitud de la fuerza restitutiva es directamente proporcional a la deformación realizada sobre él.';
			F[0][1] = 1;
			F[1] = new Array();
			F[1][0]='El trabajo neto realizado dobre una partícula es igual al cambio en su energía cinetíca';
			F[1][1] = 2;
			F[2] = new Array();
			F[2][0]='El trabajo que efectua en cualquier trayectoria cerrada es cero, o bien el trabajo no depende de la trayectoria';
			F[2][1] = 3;
			F[3] = new Array();
			F[3][0]='Ecuación dimensional de la constante de gravitación universal';
			F[3][1] = 4;
			F[4] = new Array();
			F[4][0]='Expresión de la potencia mecánica';
			F[4][1] = 5;
			F[5] = new Array();
			F[5][0]='La ley de órbitas, áreas y períodos fueron enunciadas por: ';
			F[5][1] = 6;
			F[6] = new Array();
			F[6][0]='1HP equivale a:';
			F[6][1] = 7;
			...
			D[0][2] = 0;
			D[1] = new Array();
			D[1][0]='Teorema Trabajo-Energía';
			D[1][1] = 2;
			D[1][2] = 0;
			D[2] = new Array();
			D[2][0]='Fuerzas conservativas';
			D[2][1] = 3;
			D[2][2] = 0;
			D[3] = new Array();
			D[3][0]='L3/MT2';
