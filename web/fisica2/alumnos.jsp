...
<html>
	<head> 
		<link rel="shortcut icon" href="imagenes/newton.jpg">
	<title>Alumno</title>
		...
		*::-moz-selection{
		...
		#contenedor {
			...
			width:75px; /*este ancho es para que cuadre con el texto*/ 
			height:115px; /*idem*/ 
	...
	<body>
		<div id="contenedor">
		<div id="encabezado">
                    <img src="imagenes/newton.jpg" width=75px height=115px>
		</div>
		...
		<br><br>
		 ...
		 <div id="list8">
		   <ul>
		          <li><a href="index.jsp">Ir al menú</a></li>
                          <li><a href="Pun.jsp?email=<%=email%>" target="muestra">Ver mis puntajes</a></li>
		 ...
		 <h3>Bienvenido Alumnos:</h3>
		 <p>  </p>
		 
                 <IFRAME style="border:0px" height="50%" width=100% border="0" id="muestra" name="muestra"></IFRAME>
