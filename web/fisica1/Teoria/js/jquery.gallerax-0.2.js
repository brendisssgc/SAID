		...
		// Settings
			...
			var settings = jQuery.extend({
				...
				// General settings
					...
					fade:							'slow',							// Fade duration for image transitions (0 for no fade, 'slow', 'fast', or a custom duration in ms)
					advanceDelay:					3,							// Time to wait (in ms) before automatically advancing to the next image (0 disables advancement entirely)
					...
					advanceFade:					'slow',							// Fade duration used for automatic image advancement (0 for no fade, 'slow', 'fast', or a custom duration in ms)
