...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript"> 
			...
			F = new Array();
			F[0] = new Array();
			F[0][0]='¿A que propiedad vectorial pertenece: (a+b)+c=a+(b+c)?';
			F[0][1] = 1;
			F[1] = new Array();
			F[1][0]='La Física es considerada como una ciencia:';
			F[1][1] = 2;
			F[2] = new Array();
			F[2][0]='La m&iacute;nima graduaci&oacute;n de un instrumento de medici&oacute;n se llama:';
			F[2][1] = 3;
			F[3] = new Array();
			F[3][0]='Es un error ocacionado por un accidente no predecible:';
			F[3][1] = 4;
			F[4] = new Array();
			F[4][0]='Es el producto cruz con respecto a una distancia y una fuerza';
			F[4][1] = 5;
			F[5] = new Array();
			F[5][0]='La representacion de todas las fuerzas que actuan en un cuerpo, representado en el plano cartesiano, se llama...';
			F[5][1] = 6;
			F[6] = new Array();
			F[6][0]='Al punto donde se considera que est&aacute; concentrado el peso de un cuerpo se llama:';
			F[6][1] = 7;
			...
			D[1][2] = 0;
			D[2] = new Array();
			D[2][0]='Precisi&oacute;n';
			D[2][1] = 3;
			D[2][2] = 0;
			D[3] = new Array();
			D[3][0]='Estoc&aacute;stico';
			D[3][1] = 4;
			D[3][2] = 0;
			D[4] = new Array();
			D[4][0]='El momento de una fuerza (torque o torca)';
			D[4][1] = 5;
			D[4][2] = 0;
			D[5] = new Array();
			D[5][0]='Diagrama de Cuerpo Libre';
			D[5][1] = 6;
			D[5][2] = 0;
			D[6] = new Array();
			D[6][0]='Centro de gravedad';
			D[6][1] = 7;
			D[6][2] = 0;
	...
	<body onload="TimerStartUp()" background=""> 
		<div class="Titles" id="TitleDiv">
				<form name="NavButtons1" action="">
					<table border="0" width="100%">
						<tbody>
							<tr>
								<td class="NavBar">
									<input type="button" value="Regresar el menu anterior" onclick="location='menu.jsp'"></input>
								</td>
							</tr>
						</tbody>
					</table>
				...
				Completa los conceptos moviendo los cuadros con la palabra de la derecha hac&oacute;a la izquierda <br/>
				Una vez que termines oprime el bot&oacute;n comprobar <br/>
