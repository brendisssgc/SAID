...
rs = stmt.executeQuery("Select tipo from usuarios where email=aes_encrypt('"+request.getParameter("email")+"','nomebusques')");
rs.next();

sesion.setAttribute("tipo",rs.getString("tipo"));
if(rs.getString("tipo").equals("SuperAdministrador")){response.sendRedirect("../../../../index.jsp");sesion.invalidate();}
try{
rs.close();
stmt.close();
conn.close();
